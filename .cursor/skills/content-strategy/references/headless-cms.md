...
Sanity, Contentful, and Strapi integration notes live in the upstream [marketingskills](https://github.com/coreyhaines31/marketingskills) repository under `tools/integrations/` (e.g. `sanity.md`, `contentful.md`, `strapi.md`). This project skill bundle includes only the `content-strategy` skill folder; copy those files here if you want local links.
