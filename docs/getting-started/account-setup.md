...
Welcome to Loupe Factory. This guide walks you through creating your account,
signing in securely, and configuring your organization settings so your team is
ready to go.
...
2. Choose a password or continue with a supported identity provider (Google,
   Microsoft, or SSO).
3. Verify your email address using the confirmation link sent to your inbox.

!!! info "Screenshot: Sign-Up Form"
    A screenshot will be added here showing the sign-up page with the email and
    password fields.
...
Loupe Factory uses industry-standard sign-in so your organization can use email
and password, magic links, or single sign-on (SSO) where your admin has enabled
it.
...
!!! info "Screenshot: Login screen"
    A screenshot will be added here showing the Loupe Factory login screen with
    the email entry field and SSO option where applicable.
...
After signing up, you'll be taken through a short onboarding flow to configure
your organization.
...
!!! info "Screenshot: Organization Profile Form"
    A screenshot will be added here showing the organization profile setup form
    with name, industry, currency, and timezone fields.
...
!!! info "Screenshot: Invite Team Members"
    A screenshot will be added here showing the team member invitation dialog
    with the email field and role selector.
...
!!! info "Screenshot: Notification Preferences"
    A screenshot will be added here showing the notification preferences panel
    with toggles for each notification type.
