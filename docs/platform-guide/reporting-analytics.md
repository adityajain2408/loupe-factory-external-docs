...
!!! info "Screenshot: Reports Overview Page"
    A screenshot will be added here showing the main Reports page with the module filter sidebar and the list of available report categories.
...
!!! info "Screenshot: Inventory Stock Summary Report"
    A screenshot will be added here showing the Stock Summary report table with columns for item name, category, unit, quantity on hand, and reorder threshold.
...
!!! info "Screenshot: Production Summary Report"
    A screenshot will be added here showing the Production Summary report with a table of processes, input quantities, output quantities, and waste percentages.
...
!!! info "Screenshot: Order Summary Report"
    A screenshot will be added here showing the Order Summary report with status breakdown and a revenue trend line.
...
!!! info "Screenshot: Shipment Status Summary Report"
    A screenshot will be added here showing the Shipment Status Summary with a status breakdown table and carrier comparison.
...
!!! info "Screenshot: Invoice Aging Report"
    A screenshot will be added here showing the Invoice Aging Report table with customer names, invoice amounts, and aging buckets.
...
!!! info "Screenshot: Report Chart Examples"
    A screenshot will be added here showing a report page with a line chart and a bar chart side by side, with the date range selector visible.
...
!!! info "Screenshot: Date Range Selector"
    A screenshot will be added here showing the date range picker with preset options and a custom date input calendar.
...
!!! info "Screenshot: Export Button on Report Page"
    A screenshot will be added here showing the Export button on a report page with the CSV format option highlighted.
...
- [Inventory Management](inventory-management.md) — Manage the stock data that feeds inventory reports.
- [Production Tracking](production-tracking.md) — Review production processes that appear in production reports.
- [Invoicing](invoicing.md) — Understand how invoices are generated and tracked in financial reports.
