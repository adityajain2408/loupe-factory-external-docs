...
1. Navigate to **Shipments** from the main dashboard.
2. Find the shipment in the list — the current status is shown in the **Status** column.
3. Click the shipment to open the detail view and see the full tracking timeline.
...
- [Customer & Supplier Management](customer-supplier-management.md) — Manage the recipient addresses used in shipments.
- [Reporting & Analytics](reporting-analytics.md) — View shipment reports and export delivery data.
